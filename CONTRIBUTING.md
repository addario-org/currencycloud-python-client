...
```Shell
	git clone git@github.com:your-username/currencycloud-python.git
```
...
[MIT]: LICENSE.md
[iss]: https://github.com/CurrencyCloud/currencycloud-python/issues
[pr]: https://github.com/CurrencyCloud/currencycloud-python/compare
[hof]: HALL_OF_FAME.md